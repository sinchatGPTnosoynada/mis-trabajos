    ...
    class MenuItemListener {
        ...
        public void handle(ActionEvent e) {
            ...
            if (menuConfig.containsKey(id)) {
                String[] Itens = menuConfig.get(id);
                ...
                if (Itens[2].equals("C")) {
                    ...
                    abrilArchivofxml(Itens[0], Itens[1]);
        ...
        public void abrilArchivofxml(String ruta, String titulo) {

            try {

                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource(ruta));
                fxmlLoader.setControllerFactory(context::getBean);
                Parent reet = fxmlLoader.load();

                ScrollPane scrollPane = new ScrollPane(reet);
