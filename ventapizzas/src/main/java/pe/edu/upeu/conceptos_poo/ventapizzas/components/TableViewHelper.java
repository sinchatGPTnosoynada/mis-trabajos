        ...
        Callback<TableColumn<T, Void>, TableCell<T, Void>> cellFactory = new Callback<>() {
            ...
            public TableCell<T, Void> call(final TableColumn<T, Void> param) {
                final TableCell<T, Void> cell = new TableCell<>() {
                    ...
                    // Crear las imágenes
                    Image updateImage = new Image(getClass().getResource("/img/ic_edit.png").toExternalForm());
                    Image deleteImage = new Image(getClass().getResource("/img/ic_delete.png").toExternalForm());
